	...
	return (
		<View style={[style.container]}>
			<Animated.View style={[style.container, { opacity: fadeAnim, backgroundColor: AppTheme.dark.colors.background }]}>
				...
				<View style={[style.row]}>
					<View style={style.lifeCounterContainer}>
						<LifeCounter playerIndex={4} orientation="left" />
					</View>
					<View style={style.lifeCounterContainer}>
						<LifeCounter playerIndex={5} orientation="right" />
					</View>
				</View>
			</Animated.View>
		</View>
...
const style = StyleSheet.create({
	container: {
		flex: 1,
		backgroundColor: AppTheme.dark.colors.background, // Ensure background color is set here
